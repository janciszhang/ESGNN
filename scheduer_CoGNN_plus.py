...
def schedule_tasks_CoGNN_plus(tasks, available_size, m_max = 50, is_save=False):
...
if __name__ == "__main__":
    ...
    # Schedule tasks
    final_tasks = schedule_tasks_CoGNN_plus(tasks, available_size=available_size,is_save=False)
    ...
    schedule_method_name = ['CoGNN Plus']
