...
from ESGNN.base_gnn import GNN, train, split_dataset, train_each_epoch, train_model
...
from ESGNN.metis_partition import metis_partition, partition_K
import os

from ESGNN.test_cuda import clean_gpu, set_gpu_memory
